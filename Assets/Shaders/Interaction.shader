...
Shader "Interaction"
{
	Properties
	{
		...
		_change1("change", Float) = 0
		_smoothness("smoothness", Range( 0 , 1)) = 0
		_Color0("Color 0", Color) = (0.5490196,0.4509804,0.4117647,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelNode5 = ( _Bias1 + _Scale1 * pow( 1.0 - fresnelNdotV5, 0.0 ) );
			float4 temp_cast_1 = (fresnelNode5).xxxx;
			float4 lerpResult7 = lerp( color4 , temp_cast_1 , _change1);
...
/*ASEBEGIN
Version=17800
199;131;1336;888;1036.409;221.8418;1.10241;True;False
Node;AmplifyShaderEditor.RangedFloatNode;1;-840.2664,370.3333;Inherit;False;Property;_Scale1;Scale;1;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2;-818.2662,496.3333;Inherit;False;Constant;_Power1;Power;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-835.8661,271.933;Inherit;False;Property;_Bias1;Bias;0;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;5;-567.9227,384.6637;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-460.5251,275.726;Inherit;False;Property;_change1;change;2;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-323.1497,369.05;Inherit;False;Property;_smoothness;smoothness;3;0;Create;True;0;0;False;0;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;8;-407.6021,-134.2973;Inherit;False;Property;_Color0;Color 0;4;0;Create;True;0;0;False;0;0.5490196,0.4509804,0.4117647,0;0.5490196,0.4509804,0.4117647,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=81D1A8BA6A6641CFFB2D982AC1548BB849C077F4