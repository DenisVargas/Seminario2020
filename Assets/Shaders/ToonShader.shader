...
Shader "Stylized/Toon_ColorMask"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelNode243 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV243, 0.99 ) );
			float lerpResult250 = lerp( 0.0 , fresnelNode243 , _mouseOver);
			float3 temp_cast_1 = (lerpResult250).xxx;
...
/*ASEBEGIN
Version=17800
184;142;1529;825;-67.6637;65.7693;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;244;524.1926,314.4431;Inherit;False;Property;_Bias;Bias;5;0;Create;True;0;0;False;0;0;0.24;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;246;523.7925,450.8434;Inherit;False;Constant;_Power;Power;5;0;Create;True;0;0;False;0;0.99;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;245;529.7924,381.8434;Inherit;False;Property;_Scale;Scale;6;0;Create;True;0;0;False;0;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;243;693.136,321.1739;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;242;357.7501,-15.37781;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;251;526.5335,182.2362;Inherit;False;Property;_mouseOver;mouseOver;7;1;[HideInInspector];Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;250;1039.833,139.8362;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DBDF405F7F83BA024DD2BD2CA618A57E30590CFF